...
class AlipayTradeService {
	...
	function __construct($alipay_config){
		...
		$this->private_key = $alipay_config['merchant_private_key']??$alipay_config['private_key'];
		$this->alipay_public_key = $alipay_config['alipay_public_key']??$alipay_config['ali_public_key'];
